...
if 'mostrar_signos' not in st.session_state:  # Changed to 'mostrar_signos'
    st.session_state.mostrar_signos = False
...
with st.expander("Gallbladder Ultrasound Signs:", expanded=st.session_state.mostrar_signos):  # Changed to 'mostrar_signos'
